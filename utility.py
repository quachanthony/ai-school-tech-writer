...
def format_data_for_openai(diffs, readme_content, commit_messages):
    ...
    prompt = (
        ...
        f"{changes}\n"
        "Here is the current README.md file content:\n"
        f"{readme_content}\n"
        "Consider the code changes and commit messages to determine if the README.md file needs to be updated. If so, edit the README, ensuring to maintain its existing style\n"
        "Update README:\n"
    )
...
def update_readme_and_create_pr(repo, updated_readme, readme_sha):
    ...
    repo.update_file(
        "README.md", commit_message, updated_readme, readme_sha, branch=new_branch_name
    )
